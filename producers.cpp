...
void *Producer(void *arg)
{
    ...
    { // Checks to see if rides produced has reached MAX Rides
        ...
        { // Checks to see if rideID is for human driver
            if (broker->produceRideHumanBool)
            {                                                            // Checks to see if time option was inputed for humanDriver
        ...
        { // Checks to see if rideID is for robo driver
            if (broker->produceRideRoboBool)
            {                                                           // Checks to see if time option was inputed for roboDriver
